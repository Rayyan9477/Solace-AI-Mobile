...
describe('therapySlice', () => {
  ...
  it('should return the initial state', () => {
    expect(therapyReducer(undefined, { type: undefined })).toEqual(initialState);
  });
    ...
    it('should update an existing message', () => {
      const stateWithMessages = {
        ...
        currentSession: {
          ...initialState.currentSession,
          messages: [
            { id: 'msg-1', text: 'Hello', isUser: true, timestamp: '2023-01-01T10:00:00.000Z' },
          ],
        },
      };
  ...
  describe('exercise management', () => {
    it('should start an exercise', () => {
      ...
      expect(result.currentSession.currentExercise).toBe('breathing-exercise-1');
    });
  ...
  describe('async thunks', () => {
    ...
    describe('loadTherapyHistory', () => {
      it('should load history successfully', async () => {
        const mockHistory = [{ sessionId: 'session-1' }, { sessionId: 'session-2' }];
