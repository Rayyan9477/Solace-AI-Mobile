...
describe('Crisis Configuration', () => {
  describe('CRISIS_KEYWORDS', () => {
    ...
    it('should have critical severity keywords', () => {
      ...
      const hasSupport = CRISIS_KEYWORDS.critical.some(k =>
        k.includes('suicide') || k.includes('kill myself')
      );
    ...
    it('should have high severity keywords', () => {
      ...
      const hasSelfHarm = CRISIS_KEYWORDS.high.some(k =>
        k.includes('harm') || k.includes('hurt')
      );
  ...
  describe('DANGEROUS_COMBINATIONS', () => {
    ...
    it('should include concerning combinations', () => {
      ...
      const hasPlanSuicide = combinations.some(c =>
        c.includes('plan') && c.includes('suicide')
      );
  ...
  describe('EMERGENCY_RESOURCES', () => {
    ...
    it('should include Crisis Text Line', () => {
      const hasTextLine = EMERGENCY_RESOURCES.US.some(r =>
        r.number === '741741'
      );
  ...
  describe('Configuration Consistency', () => {
    ...
    it('should have meaningful resource priorities', () => {
      const prioritySet = new Set(EMERGENCY_RESOURCES.US.map(r => r.priority));
