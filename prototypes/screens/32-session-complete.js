      ...
      <div class="h-full relative" style="background:radial-gradient(ellipse at top,#161D3D,#040818 70%);">
        ...
        <div class="relative z-10 px-6 pt-16 pb-8 h-full flex flex-col">
          ...
          <div class="flex-1 flex flex-col items-center justify-center text-center">
            <!-- Success ring -->
            <div class="relative mb-8" role="img" aria-label="Session completed successfully">
              ...
              <i data-lucide="sparkle" class="w-4 h-4 text-peach-300 absolute -top-2 right-0" aria-hidden="true"></i>
              <i data-lucide="sparkle" class="w-3 h-3 text-aurora-300 absolute bottom-4 -left-2" aria-hidden="true"></i>
              <i data-lucide="sparkle" class="w-2 h-2 text-lavender-300 absolute top-8 -right-3" aria-hidden="true"></i>
            </div>
