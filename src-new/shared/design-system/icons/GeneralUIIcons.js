  ...
  const renderIcon = () => {
    switch (name) {
      ...
      case 'sort':
        return (
          <G>
            <Path d="M3 6h18" stroke={strokeColor} strokeWidth={strokeWidth} strokeLinecap="round" />
            <Path d="M7 12h10" stroke={strokeColor} strokeWidth={strokeWidth} strokeLinecap="round" />
            <Path d="M10 18h4" stroke={strokeColor} strokeWidth={strokeWidth} strokeLinecap="round" />
          </G>
        );
      ...
      case 'list':
        return (
          <G>
            ...
            <Line x1="3" y1="6" x2="3.01" y2="6" stroke={strokeColor} strokeWidth={strokeWidth} strokeLinecap="round" />
            <Line x1="3" y1="12" x2="3.01" y2="12" stroke={strokeColor} strokeWidth={strokeWidth} strokeLinecap="round" />
            <Line x1="3" y1="18" x2="3.01" y2="18" stroke={strokeColor} strokeWidth={strokeWidth} strokeLinecap="round" />
          </G>
        );
      ...
      case 'preferences':
        return (
          <G>
            <Line x1="4" y1="21" x2="4" y2="14" stroke={strokeColor} strokeWidth={strokeWidth} strokeLinecap="round" />
            <Line x1="4" y1="10" x2="4" y2="3" stroke={strokeColor} strokeWidth={strokeWidth} strokeLinecap="round" />
            <Line x1="12" y1="21" x2="12" y2="12" stroke={strokeColor} strokeWidth={strokeWidth} strokeLinecap="round" />
            <Line x1="12" y1="8" x2="12" y2="3" stroke={strokeColor} strokeWidth={strokeWidth} strokeLinecap="round" />
            <Line x1="20" y1="21" x2="20" y2="16" stroke={strokeColor} strokeWidth={strokeWidth} strokeLinecap="round" />
            <Line x1="20" y1="12" x2="20" y2="3" stroke={strokeColor} strokeWidth={strokeWidth} strokeLinecap="round" />
            <Line x1="1" y1="14" x2="7" y2="14" stroke={strokeColor} strokeWidth={strokeWidth} strokeLinecap="round" />
            <Line x1="9" y1="8" x2="15" y2="8" stroke={strokeColor} strokeWidth={strokeWidth} strokeLinecap="round" />
            <Line x1="17" y1="16" x2="23" y2="16" stroke={strokeColor} strokeWidth={strokeWidth} strokeLinecap="round" />
          </G>
        );
        ...
        return (
          <G>
            ...
            <Polyline 
              ...
              strokeLinejoin="round" 
            />
            <Line x1="16" y1="13" x2="8" y2="13" stroke={strokeColor} strokeWidth={strokeWidth} strokeLinecap="round" />
            <Line x1="16" y1="17" x2="8" y2="17" stroke={strokeColor} strokeWidth={strokeWidth} strokeLinecap="round" />
            <Polyline points="10,9 9,9 8,9" stroke={strokeColor} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
          </G>
        );
      ...
      case 'pause':
        return (
          <G>
            <Rect x="6" y="4" width="4" height="16" fill={fillColor} stroke={strokeColor} strokeWidth={strokeWidth} />
            <Rect x="14" y="4" width="4" height="16" fill={fillColor} stroke={strokeColor} strokeWidth={strokeWidth} />
          </G>
        );
      ...
      case 'stop':
        return (
          <G>
            <Rect x="6" y="6" width="12" height="12" fill={fillColor} stroke={strokeColor} strokeWidth={strokeWidth} />
          </G>
        );
      ...
      case 'zoom-in':
        return (
          <G>
            <Circle cx="11" cy="11" r="8" fill={fillColor} stroke={strokeColor} strokeWidth={strokeWidth} />
            <Line x1="8" y1="11" x2="14" y2="11" stroke={variant === 'filled' ? '#FFFFFF' : strokeColor} strokeWidth={strokeWidth} strokeLinecap="round" />
            <Line x1="11" y1="8" x2="11" y2="14" stroke={variant === 'filled' ? '#FFFFFF' : strokeColor} strokeWidth={strokeWidth} strokeLinecap="round" />
            <Path d="m21 21-4.35-4.35" stroke={strokeColor} strokeWidth={strokeWidth} strokeLinecap="round" />
          </G>
        );
...
export const MoreHorizontalIcon = (props) => <GeneralUIIcon name="more-horizontal" {...props} />;
export const MoreVerticalIcon = (props) => <GeneralUIIcon name="more-vertical" {...props} />;
...
export const EyeOffIcon = (props) => <GeneralUIIcon name="eye-off" {...props} />;
export const GridIcon = (props) => <GeneralUIIcon name="grid" {...props} />;
export const ListIcon = (props) => <GeneralUIIcon name="list" {...props} />;
export const SettingsIcon = (props) => <GeneralUIIcon name="settings" {...props} />;
export const PreferencesIcon = (props) => <GeneralUIIcon name="preferences" {...props} />;
export const FolderIcon = (props) => <GeneralUIIcon name="folder" {...props} />;
export const FileIcon = (props) => <GeneralUIIcon name="file" {...props} />;
export const DocumentIcon = (props) => <GeneralUIIcon name="document" {...props} />;
export const CheckIcon = (props) => <GeneralUIIcon name="check" {...props} />;
export const CheckCircleIcon = (props) => <GeneralUIIcon name="check-circle" {...props} />;
export const XCircleIcon = (props) => <GeneralUIIcon name="x-circle" {...props} />;
export const AlertCircleIcon = (props) => <GeneralUIIcon name="alert-circle" {...props} />;
...
export const ZoomInIcon = (props) => <GeneralUIIcon name="zoom-in" {...props} />;
export const ZoomOutIcon = (props) => <GeneralUIIcon name="zoom-out" {...props} />;
