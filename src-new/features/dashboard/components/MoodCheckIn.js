...
import { MentalHealthIcon } from '../../../shared/design-system/icons';
import { colors, typography, spacing, borderRadius, shadows } from '../../../shared/design-system/theme';
...
MoodCheckIn.propTypes = {
  currentMood: PropTypes.oneOf([
    'happy', 'calm', 'anxious', 'sad', 'angry', 
    'neutral', 'excited', 'tired', 'stressed', 'content'
  ]),
