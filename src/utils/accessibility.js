...
export const MentalHealthAccessibility = {
  ...
  moodTracking: {
    ...
    notesInput: {
      ...
      accessibilityHint: 'Add additional notes about your current mood and feelings',
  ...
  chat: {
    ...
    inputField: {
      ...
      accessibilityHint: 'Enter your message to continue the therapy conversation',
  ...
  emergency: {
    crisisButton: {
      ...
      accessibilityHint: 'Double tap for immediate crisis support and emergency contacts',
  ...
  testMentalHealthComponent: (component, context = 'general') => {
    ...
    if (context === 'mood' && props.accessibilityLabel) {
      if (!props.accessibilityLabel.toLowerCase().includes('mood')) {
        issues.push({
          type: 'context',
          message: 'Mood-related component should include "mood" in accessibility label',
    ...
    if (context === 'emergency' && !props.accessibilityHint?.includes('crisis')) {
      issues.push({
        type: 'emergency',
        message: 'Emergency component missing crisis context in accessibility hint',
    ...
    if (context === 'therapy' && props.accessibilityLabel) {
      if (!props.accessibilityLabel.toLowerCase().includes('therapy') && 
          !props.accessibilityLabel.toLowerCase().includes('therapist')) {
        issues.push({
          type: 'context',
          message: 'Therapy component should include therapy context in accessibility label',
          recommendation: 'Add therapy/therapist context to accessibility label',
        });
      }
    }
