 ...
 */
export const createMoodAccessibility = (mood, intensity = null, isSelected = false) => {
 ...
 */
export const createTherapeuticAccessibility = (contentType, title, description = '') => {
  return {
    accessibilityRole: AccessibilityRoles.BUTTON,
    accessibilityLabel: `${contentType}: ${title}`,
    accessibilityHint: description || `Double tap to open ${contentType.toLowerCase()}`,
  };
};
 ...
 */
export const createFormInputAccessibility = (label, value = '', error = '', required = false) => {
 ...
 */
export const createProgressAccessibility = (current, total, label = 'Progress') => {
 ...
 */
export const createCardAccessibility = (title, description = '', actionHint = '') => {
  return {
    accessibilityRole: AccessibilityRoles.BUTTON,
    accessibilityLabel: title,
    accessibilityHint: actionHint || description || 'Double tap to view details',
    accessible: true,
  };
};
 ...
 */
export const createListItemAccessibility = (title, position, total, actionHint = '') => {
  return {
...
export const MentalHealthAccessibility = {
  moodTracker: {
    moodSelection: (mood, isSelected) => createMoodAccessibility(mood, null, isSelected),
    intensitySlider: (value) => createSliderAccessibility(
      'Mood intensity',
      value,
      1,
      10,
  ...
  dashboard: {
    ...
    quickAction: (actionName, description) => ({
      ...
      accessibilityHint: description || `Double tap to ${actionName.toLowerCase()}`,
    }),
