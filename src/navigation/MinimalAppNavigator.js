...
const DashboardScreen = () => (
  <SimpleScreen title="Dashboard" color="#10b981" />
);
const ChatScreen = () => (
  <SimpleScreen title="AI Therapy Chat" color="#f59e0b" />
);
const MoodScreen = () => <SimpleScreen title="Mood Tracker" color="#8b5cf6" />;
const AssessmentScreen = () => (
  <SimpleScreen title="Mental Health Assessment" color="#8b5cf6" />
);
const ProfileScreen = () => (
  <SimpleScreen title="Profile & Settings" color="#6b7280" />
);
