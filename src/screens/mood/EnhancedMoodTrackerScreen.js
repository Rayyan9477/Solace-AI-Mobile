...
const EnhancedMoodTrackerScreen = () => {
  ...
  const canProceed = () => {
    switch (currentStep) {
      ...
      case 1: return true; // Intensity always has a value
      case 2: return true; // Activities are optional
  ...
  const renderIntensitySelection = () => (
    ...
    >
      ...
      <Text style={[styles.stepSubtitle, { color: theme.colors.text.secondary }]}>
        Rate the intensity of your {selectedMood ? moods.find(m => m.id === selectedMood)?.label : 'mood'} from 1 (mild) to 5 (very intense)
      </Text>
      ...
      <View style={styles.intensityContainer}>
        ...
        <View style={styles.intensityLabels}>
          <Text style={[styles.intensityLabel, { color: theme.colors.text.tertiary }]}>
            Mild
          </Text>
          <Text style={[styles.intensityLabel, { color: theme.colors.text.tertiary }]}>
            Very Intense
        ...
        <Text style={[styles.intensityValue, { color: theme.colors.text.primary }]}>
          Current: {intensity}/5
        </Text>
      </View>
    </Animated.View>
  ...
  const renderActivitySelection = () => (
    ...
    >
      ...
      <Text style={[styles.stepSubtitle, { color: theme.colors.text.secondary }]}>
        Select any activities that might be related to your current mood (optional)
      </Text>
  ...
  const renderStep = () => {
    switch (currentStep) {
      case 0: return renderMoodSelection();
      case 1: return renderIntensitySelection();
      case 2: return renderActivitySelection();
      case 3: return renderNotesInput();
      default: return null;
    }
  };
  ...
  return (
    ...
    >
      <LinearGradient
        colors={[theme.colors.therapeutic.calming[100], theme.colors.background.primary]}
        ...
        <View style={styles.navigationContainer}>
          ...
          >
            <Text style={[
              ...
              { color: currentStep === 0 ? theme.colors.text.tertiary : theme.colors.text.primary }
            ]}>
              Previous
            </Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            ...
            accessible={true}
            accessibilityRole="button"
            accessibilityLabel={currentStep === 3 ? "Save mood entry" : "Next step"}
          >
            <LinearGradient
              colors={
                canProceed()
                  ? [theme.colors.therapeutic.calming[500], theme.colors.therapeutic.peaceful[500]]
