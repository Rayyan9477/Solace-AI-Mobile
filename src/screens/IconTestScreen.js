...
const IconTestScreen = () => {
  ...
  const IconSection = ({ title, children }) => (
    <View style={styles.section}>
      ...
      <View style={styles.iconGrid}>{children}</View>
    </View>
  );
    ...
    >
      ...
      >
        ...
        <IconSection title="Action Icons">
          <IconItem label="Add" icon={<ActionIcon name="Add" size="lg" />} />
          <IconItem label="Next" icon={<ActionIcon name="Next" size="lg" />} />
          <IconItem
            label="Expand"
        ...
        <IconSection title="Icon Variants">
          <IconItem
            label="Outline"
            icon={
              <Icon name="heart" size="lg" variant={IconVariants.OUTLINE} />
            }
          />
          <IconItem
            label="Filled"
          ...
          <IconItem
            label="Duotone"
            icon={
              <Icon name="heart" size="lg" variant={IconVariants.DUOTONE} />
            }
          />
        </IconSection>

        <IconSection title="Icon Sizes">
          <IconItem label="XS (16px)" icon={<Icon name="brain" size="xs" />} />
          <IconItem label="SM (20px)" icon={<Icon name="brain" size="sm" />} />
          <IconItem label="MD (24px)" icon={<Icon name="brain" size="md" />} />
          <IconItem label="LG (32px)" icon={<Icon name="brain" size="lg" />} />
          <IconItem label="XL (40px)" icon={<Icon name="brain" size="xl" />} />
          <IconItem
            label="2XL (48px)"
