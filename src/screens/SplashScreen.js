      ...
      >
        ...
        <View style={styles.contentContainer}>
          ...
          <Animated.View style={[styles.logoContainer, logoContainerStyle]}>
            ...
            <Animated.Text style={[styles.appTitle, { color: theme.isDark ? '#FFFFFF' : '#2D3436' }, fadeStyle]}>
              freud.ai
            </Animated.Text>
            
            {!showQuote && (
              <Animated.Text style={[styles.appSubtitle, { color: theme.isDark ? '#B2BEB5' : '#636E72' }, fadeStyle]}>
          ...
          {showQuote && (
            <Animated.View style={[styles.quoteContainer, quoteFadeStyle]}>
              ...
              <Text style={[styles.quoteText, { color: theme.isDark ? '#FFFFFF' : '#2D3436' }]}>
                "{currentQuote.text}"
              </Text>
              <Text style={[styles.quoteAuthor, { color: theme.isDark ? '#B2BEB5' : '#636E72' }]}>
                — {currentQuote.author}
              </Text>
            </Animated.View>
          )}
          ...
          {!showQuote && (
            <Animated.View style={[styles.loadingContainer, fadeStyle]}>
              <Text style={[styles.loadingText, { color: theme.isDark ? '#B2BEB5' : '#636E72' }]}>
                {currentMessage}
              </Text>
              ...
              <Text style={[styles.progressText, { color: theme.isDark ? '#B2BEB5' : '#636E72' }]}>
                {Math.round(progress)}%
              </Text>
            </Animated.View>
          )}
        ...
        <Animated.View style={[styles.bottomContainer, fadeStyle]}>
          <Text style={[styles.brandingText, { color: theme.isDark ? 'rgba(255,255,255,0.6)' : 'rgba(0,0,0,0.6)' }]}>
...
export const QuoteSplashScreen = (props) => (
  <SplashScreen {...props} showQuote={true} />
);
