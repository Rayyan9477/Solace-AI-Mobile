...
const RESOURCE_CATEGORIES = [
  { 
    id: 'resources', 
    title: 'Our Resources', 
    color: [freudDarkTheme.colors.background.secondary, freudDarkTheme.colors.background.tertiary],
    icon: '📚',
    count: '12 Resources'
  },
  { 
        ...
        <View style={styles.resourceLeft}>
          ...
          <View style={styles.resourceInfo}>
            ...
            <View style={styles.resourceStats}>
              ...
              <Text style={styles.resourceStudents}>{resource.students}+ students</Text>
            </View>
          </View>
        </View>
            ...
            >
              ...
              {article.isLocked ? (
                <TouchableOpacity style={styles.unlockButton}>
                  <Text style={styles.unlockButtonText}>Unlock Full Article</Text>
                </TouchableOpacity>
              ) : (
            ...
            >
              ...
              {course.isLocked ? (
                <TouchableOpacity style={styles.unlockCourseButton}>
                  <Text style={styles.unlockCourseButtonText}>Unlock Full Course</Text>
                </TouchableOpacity>
              ) : (
    ...
    <Animated.View style={[styles.container, { opacity: fadeAnim }]}>
      ...
      <View style={styles.mainSessionCard}>
        ...
        >
          ...
          <Text style={styles.mainSessionTitle}>Mindfulness Meditation Intro</Text>
            ...
            >
              <View style={styles.sessionLeft}>
                ...
                <View style={styles.sessionInfo}>
                  ...
                  <Text style={styles.sessionInstructor}>By {session.instructor}</Text>
            ...
            {selectedContent && (
              <ScrollView style={styles.modalContent} showsVerticalScrollIndicator={false}>
                ...
                {selectedContent.readTime && (
                  <Text style={styles.modalReadTime}>{selectedContent.readTime}</Text>
                )}
                
                {selectedContent.duration && (
                  <Text style={styles.modalDuration}>{selectedContent.duration}</Text>
                )}
                
                <Text style={styles.modalDescription}>
                  This is a comprehensive guide to mindfulness and mental wellness. 
                  Learn practical techniques for managing stress, improving focus, 
                  and developing emotional resilience through proven methods.
                  {'\n\n'}
                ...
                <TouchableOpacity style={styles.modalActionButton}>
                  ...
                  >
                    <Text style={styles.modalActionText}>
                      {selectedContent.type === 'Course' ? 'Start Course' :
                       selectedContent.type === 'Article' ? 'Read Article' :
                       'Start Session'}
                    </Text>
                  </LinearGradient>
                </TouchableOpacity>
