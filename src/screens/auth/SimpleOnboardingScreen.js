...
const SimpleOnboardingScreen = () => {
  ...
  const handleGetStarted = () => {
    ...
    try {
      ...
      console.log(
        "📱 SimpleOnboardingScreen: Auth actions dispatched successfully",
      );
    } catch (error) {
      console.error(
        "📱 SimpleOnboardingScreen: Error dispatching actions:",
        error,
      );
    }
  };
    ...
    <SafeAreaView style={dynamicStyles.container}>
      ...
      {Platform.OS === "web" && __DEV__ && (
        <View style={dynamicStyles.debugInfo}>
          ...
          <Text style={dynamicStyles.debugText}>Platform: {Platform.OS}</Text>
        </View>
      )}

      <View style={dynamicStyles.content}>
        <Text style={dynamicStyles.title}>Welcome to Solace AI</Text>
