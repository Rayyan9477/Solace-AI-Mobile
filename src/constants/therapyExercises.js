...
export const THERAPY_EXERCISES = [
  {
    ...
    completionMessage:
      "Great job! This grounding technique helps anchor you to the present moment. How do you feel now?",
  },
  {
    ...
    completionMessage:
      "Excellent breathing work! This technique activates your body's relaxation response. Notice any changes in how you feel?",
  },
  {
    ...
    completionMessage:
      "That was thoughtful work challenging those automatic thoughts. Remember, thoughts are not facts - they're just mental events that pass through our minds.",
  },
  {
    id: "mood_exploration",
    title: "Mood Check-In",
    ...
    completionMessage:
      "Thank you for taking the time to check in with your emotions. Emotional awareness is the first step toward emotional wellness.",
  },
  {
    ...
    completionMessage:
      "Wonderful relaxation work! This technique helps your body remember what relaxation feels like and can be used anytime you notice tension.",
  },
  {
    ...
    completionMessage:
      "Gratitude practice is a powerful way to shift our focus toward the positive aspects of our lives. Consider keeping a daily gratitude journal.",
  },
  {
    ...
    completionMessage:
      "Understanding your values is like having a compass for life decisions. When we live in alignment with our values, we often feel more fulfilled and authentic.",
  },
  {
    id: "self_compassion",
    ...
    completionMessage:
      "Self-compassion isn't about being easy on yourself - it's about being kind to yourself. This practice can help reduce self-criticism and increase emotional resilience.",
  },
];
...
export const getExercisesByDifficulty = (difficulty) => {
  return THERAPY_EXERCISES.filter(
...
export const getRandomExercise = () => {
  return THERAPY_EXERCISES[
    Math.floor(Math.random() * THERAPY_EXERCISES.length)
  ];
};
