...
import KeyboardAwareScrollView, { KeyboardAwareInput } from '../../components/common/KeyboardAwareScrollView';
  ...
  useTheme: () => ({
    theme: {
      colors: {
        ...
        error: { 500: '#FF3B30', 50: '#FFE5E5', 600: '#CC0000', 700: '#990000' },
        text: { primary: '#000000', secondary: '#666666', placeholder: '#999999' },
        background: { primary: '#FFFFFF', secondary: '#F5F5F5', surface: '#FAFAFA' },
        border: { primary: '#E0E0E0' },
        mood: { happy: '#FFD700', calm: '#87CEEB', anxious: '#FFA500' },
        therapeutic: { calm: '#E6F3FF', nurturing: '#E8F5E8', peaceful: '#F0F8FF' },
      },
...
jest.mock('../../utils/accessibility', () => ({
  ...
  TouchTargetHelpers: {
    ensureMinimumTouchTarget: (style) => ({ style, hitSlop: { top: 10, bottom: 10, left: 10, right: 10 } }),
  },
  WCAG_CONSTANTS: {
  ...
  describe('KeyboardAwareScrollView', () => {
    ...
    test('applies mental health styling for therapy forms', () => {
      const { getByTestId } = render(
        <KeyboardAwareScrollView 
          isTherapyForm={true}
          testID="therapy-scroll"
        >
          <EnhancedInput label="Therapy Input" value="" onChangeText={() => {}} />
        </KeyboardAwareScrollView>
      );
...
describe('Navigation and Forms Integration', () => {
  ...
  test('accessibility history tracks form navigation', async () => {
    ...
    const { saveAccessibilityHistory } = require('../../utils/navigationPersistence');
