...
const defaultNotifications = [
  ...
  },
  {
    ...
    subtitle: "Jordan B. just posted a video.",
    avatarColor: "#3498DB",
  },
  {
    id: "n5",
    ...
    subtitle: "Maya S. just mentioned you.",
    avatarColor: "#7B68B5",
  },
];
...
describe("CommunityNotificationsScreen", () => {
  ...
  it("renders the screen container", () => {
    const { getByTestId } = render(
      <CommunityNotificationsScreen {...defaultProps} />,
    );
  ...
  it("renders as a full-screen flex container", () => {
    ...
    const flat = Object.assign(
      {},
      ...[].concat(getByTestId("community-notifications-screen").props.style),
    );
  ...
  it("notification rows have accessibilityRole button", () => {
    ...
    expect(getByTestId("notification-row-n1").props.accessibilityRole).toBe(
      "button",
    );
  });
