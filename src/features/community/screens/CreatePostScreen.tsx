...
export const CreatePostScreen = () => {
  ...
  const [postType, setPostType] = useState<'story' | 'question' | 'poll'>('story');
        ...
        <View style={styles.section}>
          ...
          <View style={styles.typeSelector}>
            ...
            >
              ...
              <Text style={[styles.typeText, postType === 'story' && styles.typeTextActive]}>
                Story
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={[styles.typeButton, postType === 'question' && styles.typeButtonActive]}
              onPress={() => setPostType('question')}
            >
              <Text style={styles.typeIcon}>❓</Text>
              <Text style={[styles.typeText, postType === 'question' && styles.typeTextActive]}>
                Question
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
            ...
            >
              <Text style={styles.typeIcon}>📊</Text>
              <Text style={[styles.typeText, postType === 'poll' && styles.typeTextActive]}>
                Poll
              </Text>
            </TouchableOpacity>
          </View>
            ...
            {ACTIVITIES.map((activity) => (
              <TouchableOpacity
                ...
                style={[
                  ...
                  selectedActivities.includes(activity.label) && styles.activityButtonActive,
                ]}
              ...
              >
                ...
                <Text style={[
                  styles.activityText,
                  selectedActivities.includes(activity.label) && styles.activityTextActive,
                ]}>
                  {activity.label}
                </Text>
              </TouchableOpacity>
        ...
        <View style={styles.section}>
          ...
          >
            <View>
              ...
              <Text style={styles.toggleSubtext}>This post will be private</Text>
            </View>
            <View style={[styles.switch, hideFromCommunity && styles.switchActive]}>
              <View style={[
                styles.switchThumb,
