...
const styles = StyleSheet.create({
  ...
  downloadRow: {
    alignItems: "center",
    backgroundColor: localColors.downloadBg,
    borderRadius: 16,
    flexDirection: "row",
    marginHorizontal: 24,
    marginTop: 16,
  ...
  downloadSize: { color: localColors.textSecondary, fontSize: 13, marginRight: 12 },
  followButton: {
  ...
  lessonHeaderText: { color: localColors.white, fontSize: 16, fontWeight: "700" },
  ...
  lessonPlayText: { color: localColors.white, fontSize: 14 },
  lessonRating: { color: localColors.textSecondary, fontSize: 12 },
  lessonRow: {
    alignItems: "center",
  ...
  lessonTitle: { color: localColors.white, fontSize: 15, fontWeight: "600" },
  paywall: {
    alignItems: "center",
    marginTop: 32,
    paddingHorizontal: 24,
