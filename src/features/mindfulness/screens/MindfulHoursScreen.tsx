...
const EXERCISES: Exercise[] = [
  { id: '1', name: 'Breathing', duration: '2.1h', percentage: 20, color: '#98B068', icon: '🫁' },
  { id: '2', name: 'Mindfulness', duration: '1.7h', percentage: 17, color: '#C96100', icon: '🧘' },
  { id: '3', name: 'Relax', duration: '0h', percentage: 40, color: '#704A33', icon: '😌' },
  { id: '4', name: 'Sleep', duration: '0h', percentage: 80, color: '#6B5FC8', icon: '😴' },
];

const HISTORY = [
  { id: '1', name: 'Deep Meditation', duration: '00:05', date: '20:00', color: '#98B068' },
  { id: '2', name: 'Balanced Sleep', duration: '08:00', date: '22:00', color: '#6B5FC8' },
];
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: theme.colors.background.primary }]}>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity>
          <Text style={[styles.downloadIcon, { color: theme.colors.text.primary }]}>↓</Text>
        </TouchableOpacity>
      </View>
            ...
            >
              <View style={styles.exerciseLeft}>
                ...
                <View>
                  ...
                  <Text style={[styles.exerciseDuration, { color: theme.colors.text.secondary }]}>
                    {exercise.duration}
                  </Text>
                </View>
              </View>
              <Text style={[styles.exercisePercentage, { color: theme.colors.text.secondary }]}>
                {exercise.percentage}%
              </Text>
            </TouchableOpacity>
          ))}
          ...
          {HISTORY.map((item) => (
            ...
            >
              <View style={styles.historyLeft}>
                ...
                <View>
                  <Text style={[styles.historyName, { color: theme.colors.text.primary }]}>
                    {item.name}
                  </Text>
                  <Text style={[styles.historyTime, { color: theme.colors.text.secondary }]}>
                    {item.date}
                  </Text>
                </View>
              </View>
              <Text style={[styles.historyDuration, { color: theme.colors.text.primary }]}>
                {item.duration}
              </Text>
            </View>
          ))}
