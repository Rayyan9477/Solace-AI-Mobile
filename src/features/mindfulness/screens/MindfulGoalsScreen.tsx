...
export const MindfulGoalsScreen = () => {
  ...
  const progressPercentage = Math.round((currentProgress.todayMinutes / currentProgress.goalMinutes) * 100);
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.progressCard}>
          ...
          <View style={styles.circularProgress}>
            <View style={styles.circularProgressOuter}>
              <View style={styles.circularProgressInner}>
                <Text style={styles.progressValue}>{currentProgress.todayMinutes}</Text>
                <Text style={styles.progressTarget}>/ {currentProgress.goalMinutes} min</Text>
              </View>
            </View>
            <Text style={styles.progressLabel}>{progressPercentage}% Complete</Text>
          </View>
          ...
          <View style={styles.statsRow}>
            ...
            <View style={styles.statItem}>
              <Text style={styles.statValue}>{currentProgress.weeklyTotal}</Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.goalSelector}>
            <Text style={styles.goalSelectorTitle}>Set your daily mindfulness target</Text>
                ...
                >
                  <Text
                    style={[
                      ...
                      dailyGoalMinutes === minutes && styles.goalOptionTextSelected,
                    ]}
                  >
                    {minutes}m
                  </Text>
            ...
            <View style={styles.weeklyChart}>
              {weeklyProgress.map((day, index) => (
                <View key={index} style={styles.dayColumn}>
                  <Text style={styles.dayMinutes}>{day.minutes > 0 ? `${day.minutes}m` : ''}</Text>
                  <View
                    style={[
                      styles.dayBar,
                      day.completed ? styles.dayBarCompleted : styles.dayBarIncomplete,
                      { height: day.minutes > 0 ? `${(day.minutes / 30) * 100}%` : 8 },
                    ]}
                  />
