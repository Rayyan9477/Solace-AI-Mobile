...
interface JournalCalendarScreenProps {
  onBack?: () => void;
}

export function JournalCalendarScreen({
  onBack,
}: JournalCalendarScreenProps = {}): React.ReactElement {
  ...
  return (
    <View testID="journal-calendar-screen" style={styles.container}>
      {/* Header */}
      ...
      <View style={styles.content}>
        <View style={styles.iconContainer}>
          <Icon name="calendar-outline" size={72} color={palette.tan[400]} />
        </View>
