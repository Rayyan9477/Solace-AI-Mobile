      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.statsCard}>
          ...
          <View style={styles.statsGrid}>
            ...
            <View style={styles.statItem}>
              <Text style={styles.statValue}>{(stats.totalWords / 1000).toFixed(1)}k</Text>
        ...
        <View style={styles.section}>
          ...
          {dateRanges.map((range) => (
            ...
            >
              ...
              >
                {selectedRange === range.id && <Text style={styles.selectionCheck}>✓</Text>}
              </View>
            </TouchableOpacity>
          ))}
        </View>
        ...
        <View style={styles.privacyCard}>
          ...
          <View style={styles.privacyText}>
            ...
            <Text style={styles.privacyDescription}>
              Your journal entries are encrypted during export. We recommend using secure methods to share or store your data.
            </Text>
          </View>
        </View>
