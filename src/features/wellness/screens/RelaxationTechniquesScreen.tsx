      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.heroCard}>
          ...
          <Text style={styles.heroSubtitle}>
            Discover proven relaxation techniques to reduce stress and find inner peace
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.quickTechniquesRow}>
            {quickTechniques.map((technique) => (
              <TouchableOpacity key={technique.id} style={styles.quickTechniqueCard}>
          ...
          {techniques.map((technique) => (
            ...
            >
              <View style={styles.techniqueHeader}>
                ...
                <View style={[styles.difficultyBadge, getDifficultyStyle(technique.difficulty)]}>
