...
export const MoodHistoryScreen = () => {
  ...
  const dailyMoods: MoodEntry[] = [
    { id: '1', date: 'Today, 2:30 PM', mood: 'Happy', emoji: '😊', intensity: 80 },
    { id: '2', date: 'Today, 10:00 AM', mood: 'Neutral', emoji: '😐', intensity: 50 },
    { id: '3', date: 'Yesterday, 6:00 PM', mood: 'Excited', emoji: '🤩', intensity: 95 },
    { id: '4', date: 'Yesterday, 2:00 PM', mood: 'Sad', emoji: '😢', intensity: 30 },
    { id: '5', date: '2 days ago, 4:00 PM', mood: 'Happy', emoji: '😊', intensity: 75 },
  ];
          ...
          <View style={styles.statsCard}>
            ...
            <View style={styles.statsRow}>
              <View style={styles.statItem}>
                ...
                <Text style={styles.statValue}>{weeklyStats.mostCommonMood}</Text>
              </View>
              <View style={styles.statItem}>
                <Text style={styles.statLabel}>Avg Intensity</Text>
                <Text style={styles.statValue}>{weeklyStats.averageIntensity}%</Text>
              </View>
              <View style={styles.statItem}>
            ...
            <Text style={[styles.statsTitle, { marginTop: 16 }]}>Mood Distribution</Text>
                ...
                <View style={styles.distributionBar}>
                  <View
                    style={[
                      ...
                      { width: `${item.percentage}%`, backgroundColor: getMoodColor(item.mood) },
                    ]}
                  />
                </View>
                  ...
                  <View style={styles.intensityBar}>
                    <View
                      style={[
                        ...
                        { width: `${entry.intensity}%`, backgroundColor: getMoodColor(entry.mood) },
                      ]}
                    />
                  </View>
                </View>
