  ...
  reducers: {
    ...
    updateStats: (state) => {
      ...
      if (monthlyEntries.length > 0) {
        const monthlyAvg =
          monthlyEntries.reduce((sum, entry) => sum + entry.intensity, 0) /
    ...
    detectPatterns: (state) => {
      ...
      entries.forEach((entry) => {
        ...
        hourlyMoods[hour].push({
          mood: entry.mood,
          intensity: entry.intensity,
        });
        weekdayMoods[weekday].push({
          mood: entry.mood,
          intensity: entry.intensity,
        });
      });
    ...
    generateEnhancedInsights: (state) => {
      ...
      if (weeklyStats.averageIntensity <= 2) {
        insights.push({
          ...
          title: "Extra Support 🤗",
          message:
            "Your mood has been lower lately. This is normal - everyone has difficult periods. Consider reaching out for support.",
          icon: "🤗",
          actionable: true,
          actions: [
          ...
          anxious: [
            {
              ...
              description: "Try deep breathing to calm anxiety",
          ...
          sad: [
            {
              ...
              action: "gratitude_exercise",
            },
            {
              title: "Gentle Movement",
              description: "Light exercise can boost mood",
          ...
          stressed: [
            {
              ...
              description: "Organize your tasks by importance",
              action: "organization_tool",
            },
            {
              title: "Mindful Break",
            ...
            },
            {
              ...
              description: "Practice saying no to reduce overwhelm",
