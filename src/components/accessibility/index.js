...
export { default as MentalHealthAccessible, useMentalHealthAccessibility } from './MentalHealthAccessible';
...
export const MentalHealthA11yProps = {
  ...
  mood: (moodType, isSelected = false) => ({
    ...
    accessibilityHint: isSelected ? 'Currently selected mood' : `Select ${moodType} as your mood`,
