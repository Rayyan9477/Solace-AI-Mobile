...
export const BrainIcon = ({ size = 24, color = freudTheme.colors.text.primary, strokeWidth = 2 }) => (
...
export const HeartIcon = ({ size = 24, color = freudTheme.colors.text.primary, strokeWidth = 2 }) => (
  <FreudIcon size={size} color={color}>
    <Path
...
export const MindfulnessIcon = ({ size = 24, color = freudTheme.colors.text.primary, strokeWidth = 2 }) => (
  <FreudIcon size={size} color={color}>
    ...
    <Path d="M12 2L12 6" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" />
    <Path d="M12 18L12 22" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" />
    <Path d="M22 12L18 12" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" />
    <Path d="M6 12L2 12" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" />
  </FreudIcon>
);

export const TherapyIcon = ({ size = 24, color = freudTheme.colors.text.primary, strokeWidth = 2 }) => (
  <FreudIcon size={size} color={color}>
    <Rect x="3" y="8" width="18" height="13" rx="2" ry="2" stroke={color} strokeWidth={strokeWidth} fill="none" />
    <Path d="M8 21V16C8 15.4 8.4 15 9 15H15C15.6 15 16 15.4 16 16V21" stroke={color} strokeWidth={strokeWidth} fill="none" />
    <Path d="M8 8V6C8 3.8 9.8 2 12 2C14.2 2 16 3.8 16 6V8" stroke={color} strokeWidth={strokeWidth} />
    <Circle cx="12" cy="11" r="1" fill={color} />
  </FreudIcon>
);

export const MeditationIcon = ({ size = 24, color = freudTheme.colors.text.primary, strokeWidth = 2 }) => (
  <FreudIcon size={size} color={color}>
    <Circle cx="12" cy="8" r="4" stroke={color} strokeWidth={strokeWidth} fill="none" />
    <Path d="M8 14C8 14 8 18 12 18C16 18 16 14 16 14" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" />
    <Path d="M6 14L6 16C6 17.1 6.9 18 8 18" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" />
    <Path d="M18 14L18 16C18 17.1 17.1 18 16 18" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" />
    <Circle cx="9" cy="9" r="1" fill={color} />
    <Circle cx="15" cy="9" r="1" fill={color} />
  </FreudIcon>
);

export const JournalIcon = ({ size = 24, color = freudTheme.colors.text.primary, strokeWidth = 2 }) => (
  <FreudIcon size={size} color={color}>
    <Rect x="4" y="2" width="16" height="20" rx="2" ry="2" stroke={color} strokeWidth={strokeWidth} fill="none" />
...
export const InsightsIcon = ({ size = 24, color = freudTheme.colors.text.primary, strokeWidth = 2 }) => (
  <FreudIcon size={size} color={color}>
    <Path d="M3 17L9 11L13 15L21 7" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
    <Path d="M21 7L16 7L16 12" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
...
// Navigation Icons
export const HomeIcon = ({ size = 24, color = freudTheme.colors.text.primary, strokeWidth = 2, filled = false }) => (
  <FreudIcon size={size} color={color}>
    <Path
      ...
      strokeLinejoin="round"
    />
    <Path d="M9 22V12H15V22" stroke={color} strokeWidth={strokeWidth} fill="none" strokeLinecap="round" strokeLinejoin="round" />
  </FreudIcon>
);

export const ChatIcon = ({ size = 24, color = freudTheme.colors.text.primary, strokeWidth = 2, filled = false }) => (
  <FreudIcon size={size} color={color}>
    <Path
...
export const MoodIcon = ({ size = 24, color = freudTheme.colors.text.primary, strokeWidth = 2, filled = false }) => (
  <FreudIcon size={size} color={color}>
    <Circle 
      cx="12" 
      cy="12" 
      ...
      fill={filled ? color : 'none'} 
    />
    <Path d="M8 14S9.5 16 12 16S16 14 16 14" stroke={filled ? 'white' : color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
    <Line x1="9" y1="9" x2="9.01" y2="9" stroke={filled ? 'white' : color} strokeWidth={strokeWidth + 1} strokeLinecap="round" strokeLinejoin="round" />
    <Line x1="15" y1="9" x2="15.01" y2="9" stroke={filled ? 'white' : color} strokeWidth={strokeWidth + 1} strokeLinecap="round" strokeLinejoin="round" />
  </FreudIcon>
);

export const AssessmentIcon = ({ size = 24, color = freudTheme.colors.text.primary, strokeWidth = 2, filled = false }) => (
  <FreudIcon size={size} color={color}>
    <Rect 
      x="3" 
      y="3" 
      ...
      fill={filled ? color : 'none'} 
    />
    <Path d="M9 9L11 11L15 7" stroke={filled ? 'white' : color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
  </FreudIcon>
);

export const ProfileIcon = ({ size = 24, color = freudTheme.colors.text.primary, strokeWidth = 2, filled = false }) => (
  <FreudIcon size={size} color={color}>
    <Path 
...
// Action Icons
export const PlusIcon = ({ size = 24, color = freudTheme.colors.text.primary, strokeWidth = 2 }) => (
  <FreudIcon size={size} color={color}>
...
export const ChevronRightIcon = ({ size = 24, color = freudTheme.colors.text.primary, strokeWidth = 2 }) => (
  <FreudIcon size={size} color={color}>
    <Polyline points="9,18 15,12 9,6" stroke={color} strokeWidth={strokeWidth} fill="none" strokeLinecap="round" strokeLinejoin="round" />
  </FreudIcon>
);

export const ChevronLeftIcon = ({ size = 24, color = freudTheme.colors.text.primary, strokeWidth = 2 }) => (
  <FreudIcon size={size} color={color}>
    <Polyline points="15,18 9,12 15,6" stroke={color} strokeWidth={strokeWidth} fill="none" strokeLinecap="round" strokeLinejoin="round" />
  </FreudIcon>
);

export const SearchIcon = ({ size = 24, color = freudTheme.colors.text.primary, strokeWidth = 2 }) => (
  <FreudIcon size={size} color={color}>
...
export const ThemedFreudIcon = ({ name, variant = 'outline', size = 24, color, ...props }) => {
  ...
  return <IconComponent size={size} color={iconColor} filled={filled} {...props} />;
};
