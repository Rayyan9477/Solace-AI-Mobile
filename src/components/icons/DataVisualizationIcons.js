...
export const BarChartIcon = (props) => (
  <DataVisualizationIcon name="bar-chart" {...props} />
);
export const LineChartIcon = (props) => (
  <DataVisualizationIcon name="line-chart" {...props} />
);
export const AreaChartIcon = (props) => (
  <DataVisualizationIcon name="area-chart" {...props} />
);
export const PieChartIcon = (props) => (
  <DataVisualizationIcon name="pie-chart" {...props} />
);
export const DonutChartIcon = (props) => (
  <DataVisualizationIcon name="donut-chart" {...props} />
);
export const ScatterPlotIcon = (props) => (
  <DataVisualizationIcon name="scatter-plot" {...props} />
);
export const ProgressRingIcon = (props) => (
  <DataVisualizationIcon name="progress-ring" {...props} />
);
export const ProgressBarIcon = (props) => (
  <DataVisualizationIcon name="progress-bar" {...props} />
);
export const AnalyticsIcon = (props) => (
  <DataVisualizationIcon name="analytics" {...props} />
);
export const TrendingUpIcon = (props) => (
  <DataVisualizationIcon name="trending-up" {...props} />
);
export const TrendingDownIcon = (props) => (
  <DataVisualizationIcon name="trending-down" {...props} />
);
export const MoodGraphIcon = (props) => (
  <DataVisualizationIcon name="mood-graph" {...props} />
);
export const WellnessMeterIcon = (props) => (
  <DataVisualizationIcon name="wellness-meter" {...props} />
);
export const StressLevelIcon = (props) => (
  <DataVisualizationIcon name="stress-level" {...props} />
);
export const DataTableIcon = (props) => (
  <DataVisualizationIcon name="data-table" {...props} />
);
export const DataListIcon = (props) => (
  <DataVisualizationIcon name="data-list" {...props} />
);
export const StatisticsIcon = (props) => (
  <DataVisualizationIcon name="statistics" {...props} />
);
export const MetricsIcon = (props) => (
  <DataVisualizationIcon name="metrics" {...props} />
);
export const DashboardDataIcon = (props) => (
  <DataVisualizationIcon name="dashboard-data" {...props} />
);
export const CompareIcon = (props) => (
  <DataVisualizationIcon name="compare" {...props} />
);
export const CorrelationIcon = (props) => (
  <DataVisualizationIcon name="correlation" {...props} />
);
export const HeartRateChartIcon = (props) => (
  <DataVisualizationIcon name="heart-rate-chart" {...props} />
);
export const SleepChartIcon = (props) => (
  <DataVisualizationIcon name="sleep-chart" {...props} />
);
