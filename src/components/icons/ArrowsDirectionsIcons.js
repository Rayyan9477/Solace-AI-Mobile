      ...
      case "rotate-cw":
        return (
          <G>
            ...
            />
            <Path
              d="M20.49 9A9 9 0 1 0 5.64 5.64L1 10"
              stroke={strokeColor}
              strokeWidth={strokeWidth}
              strokeLinecap="round"
              strokeLinejoin="round"
      ...
      case "rotate-ccw":
        return (
          <G>
            ...
            />
            <Path
              d="M3.51 9a9 9 0 1 1 14.85-3.36L23 10"
              stroke={strokeColor}
              strokeWidth={strokeWidth}
              strokeLinecap="round"
              strokeLinejoin="round"
...
export const ArrowUpIcon = (props) => (
  <ArrowDirectionIcon name="arrow-up" {...props} />
);
export const ArrowDownIcon = (props) => (
  <ArrowDirectionIcon name="arrow-down" {...props} />
);
export const ArrowLeftIcon = (props) => (
  <ArrowDirectionIcon name="arrow-left" {...props} />
);
export const ArrowRightIcon = (props) => (
  <ArrowDirectionIcon name="arrow-right" {...props} />
);
export const ArrowUpRightIcon = (props) => (
  <ArrowDirectionIcon name="arrow-up-right" {...props} />
);
export const ArrowUpLeftIcon = (props) => (
  <ArrowDirectionIcon name="arrow-up-left" {...props} />
);
export const ArrowDownRightIcon = (props) => (
  <ArrowDirectionIcon name="arrow-down-right" {...props} />
);
export const ArrowDownLeftIcon = (props) => (
  <ArrowDirectionIcon name="arrow-down-left" {...props} />
);
export const ChevronUpIcon = (props) => (
  <ArrowDirectionIcon name="chevron-up" {...props} />
);
export const ChevronDownIcon = (props) => (
  <ArrowDirectionIcon name="chevron-down" {...props} />
);
export const ChevronLeftIcon = (props) => (
  <ArrowDirectionIcon name="chevron-left" {...props} />
);
export const ChevronRightIcon = (props) => (
  <ArrowDirectionIcon name="chevron-right" {...props} />
);
export const ChevronsUpIcon = (props) => (
  <ArrowDirectionIcon name="chevrons-up" {...props} />
);
export const ChevronsDownIcon = (props) => (
  <ArrowDirectionIcon name="chevrons-down" {...props} />
);
export const ChevronsLeftIcon = (props) => (
  <ArrowDirectionIcon name="chevrons-left" {...props} />
);
export const ChevronsRightIcon = (props) => (
  <ArrowDirectionIcon name="chevrons-right" {...props} />
);
export const RefreshCwIcon = (props) => (
  <ArrowDirectionIcon name="refresh-cw" {...props} />
);
export const RefreshCcwIcon = (props) => (
  <ArrowDirectionIcon name="refresh-ccw" {...props} />
);
export const RotateCwIcon = (props) => (
  <ArrowDirectionIcon name="rotate-cw" {...props} />
);
export const RotateCcwIcon = (props) => (
  <ArrowDirectionIcon name="rotate-ccw" {...props} />
);
export const CornerUpLeftIcon = (props) => (
  <ArrowDirectionIcon name="corner-up-left" {...props} />
);
export const CornerUpRightIcon = (props) => (
  <ArrowDirectionIcon name="corner-up-right" {...props} />
);
export const CornerDownLeftIcon = (props) => (
  <ArrowDirectionIcon name="corner-down-left" {...props} />
);
export const CornerDownRightIcon = (props) => (
  <ArrowDirectionIcon name="corner-down-right" {...props} />
);
export const NavigationIcon = (props) => (
  <ArrowDirectionIcon name="navigation" {...props} />
);
export const CompassIcon = (props) => (
  <ArrowDirectionIcon name="compass" {...props} />
);
export const MoveIcon = (props) => (
  <ArrowDirectionIcon name="move" {...props} />
);
export const DragIcon = (props) => (
  <ArrowDirectionIcon name="drag" {...props} />
);
export const ExpandIcon = (props) => (
  <ArrowDirectionIcon name="expand" {...props} />
);
export const CollapseIcon = (props) => (
  <ArrowDirectionIcon name="collapse" {...props} />
);
export const BackIcon = (props) => (
  <ArrowDirectionIcon name="back" {...props} />
);
export const ForwardIcon = (props) => (
  <ArrowDirectionIcon name="forward" {...props} />
);
export const SkipBackIcon = (props) => (
  <ArrowDirectionIcon name="skip-back" {...props} />
);
export const SkipForwardIcon = (props) => (
  <ArrowDirectionIcon name="skip-forward" {...props} />
);
