...
console.log(
  "🔧 WebSafeSvg: Initializing SVG components for platform:",
  Platform.OS,
);
...
if (Platform.OS === "web") {
  try {
    ...
    console.log(
      "🔧 WebSafeSvg: react-native-svg loaded successfully",
      !!svgComponents,
    );
    ...
    console.warn(
      "🔧 WebSafeSvg: react-native-svg not available on web, using HTML fallbacks:",
      error,
    );
  ...
  try {
    ...
    console.error(
      "🔧 WebSafeSvg: Failed to load native SVG components:",
      error,
    );
    throw error;
  }
...
export { Svg, Path, Circle, Rect, Line, Polyline, Polygon, G };
