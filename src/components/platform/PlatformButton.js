...
import { TouchableOpacity, Pressable, StyleSheet, Text, ActivityIndicator } from 'react-native';
...
const PlatformButton = ({
  ...
  const TouchableComponent = PLATFORM_CONFIG.isWeb ? Pressable : TouchableOpacity;
