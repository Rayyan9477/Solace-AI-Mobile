...
// Legacy theme provider (older context API)
import { ThemeProvider as LegacyThemeProvider } from "../shared/theme/ThemeContext";
// Unified theme provider (new consolidated API used by many components)
...
export const AppProvider = ({ children }) => {
  ...
  return (
    ...
    >
      {/*
        Provide BOTH theme contexts to bridge components gradually migrating
        to the UnifiedThemeProvider. Components importing either
        '../shared/theme/ThemeContext' or '../shared/theme/UnifiedThemeProvider'
        will now have a provider available, preventing 'useTheme must be used within'
        runtime errors that caused blank/white screens during navigation rendering.
      */}
          ...
          <PerformanceMonitor>
            <AccessibilityAnnouncer>
              <MentalHealthProvider>
                <PrivacyProtection>{children}</PrivacyProtection>
              </MentalHealthProvider>
            </AccessibilityAnnouncer>
          </PerformanceMonitor>
        </LegacyThemeProvider>
