...
export const useTherapySession = (sessionType = 'general') => {
  ...
  const therapyExercises = useMemo(() => ({
    grounding: {
      ...
      steps: [
        {
          instruction: "Let's try the 5-4-3-2-1 grounding technique. First, name 5 things you can see around you.",
          type: 'visual',
          timeout: 60000
        },
        {
      ...
      completion: "Excellent work! How do you feel now compared to when we started?"
    },
    breathing: {
      id: 'breathing_4_7_8',
      title: '4-7-8 Breathing',
      description: 'Deep breathing technique to reduce anxiety and promote calm',
      category: 'anxiety',
      ...
      steps: [
        {
          instruction: "Let's practice 4-7-8 breathing together. First, exhale completely through your mouth.",
          type: 'preparation',
          timeout: 15000
        },
        {
        ...
        {
          instruction: "Exhale completely through your mouth for 8 counts. 1... 2... 3... 4... 5... 6... 7... 8...",
          type: 'exhale',
          timeout: 30000
        },
        {
    ...
    thoughtChallenging: {
      ...
      steps: [
        {
          instruction: "What's a specific thought that's been bothering you lately? Share it with me.",
          type: 'identification',
          timeout: 120000
        },
        {
          instruction: "Thank you for sharing that. What evidence do you have that this thought is absolutely true?",
          type: 'evidence_for',
          timeout: 90000
        },
        {
          instruction: "Now, what evidence contradicts this thought? What might suggest it's not entirely accurate?",
          type: 'evidence_against',
          timeout: 90000
        },
        {
          instruction: "If your best friend had this exact thought, what would you tell them?",
          type: 'friend_perspective',
          timeout: 90000
        },
        {
          instruction: "Based on what we've explored, how could we reframe this thought in a more balanced way?",
          type: 'reframing',
          timeout: 120000
        }
      ],
      completion: "Excellent work challenging that thought. You've shown great insight!"
    },
    moodExploration: {
      id: 'mood_exploration',
      ...
      steps: [
        {
          instruction: "How are you feeling right now, on a scale of 1-10? Please tell me the number and the main emotion.",
          type: 'mood_rating',
          timeout: 60000
        },
        {
          instruction: "Thank you. Can you name 2-3 specific emotions you're experiencing? Sometimes we feel multiple things at once.",
          type: 'emotion_identification',
          timeout: 90000
        },
        {
          instruction: "Where do you feel these emotions in your body? Are there any physical sensations?",
          type: 'body_awareness',
          timeout: 90000
        },
        {
          instruction: "What do you think might have contributed to feeling this way today? Any specific events or thoughts?",
          type: 'trigger_exploration',
          timeout: 120000
        },
        {
          instruction: "What would help you feel even just 10% better right now? What small step could we take together?",
          type: 'coping_planning',
          timeout: 120000
        }
      ],
      completion: "Thank you for being so open about your feelings. Your emotional awareness is a real strength."
    },
    progressiveRelaxation: {
      ...
      steps: [
        {
          instruction: "Let's do progressive muscle relaxation. First, find a comfortable position and close your eyes if that feels safe.",
          type: 'preparation',
          timeout: 30000
        },
        {
          instruction: "Start with your toes. Tense them tightly for 5 seconds... hold it... and now release. Notice the contrast.",
          type: 'feet',
          timeout: 45000
        },
        {
          instruction: "Now your calves and legs. Tense them up... hold for 5 seconds... and release. Feel the relaxation.",
          type: 'legs',
          timeout: 45000
        },
        {
          instruction: "Move to your abdomen and chest. Tense these muscles... hold... and let go. Breathe naturally.",
          type: 'core',
          timeout: 45000
        },
        {
          instruction: "Now your hands and arms. Make fists and tense your arms... hold it... and release completely.",
          type: 'arms',
          timeout: 45000
        },
        {
          instruction: "Finally, your shoulders, neck, and face. Scrunch everything up... hold... and let it all go.",
          type: 'head',
          timeout: 45000
        },
        {
          instruction: "Take a moment to notice your whole body. How does this relaxed state feel different from when we started?",
          type: 'integration',
          timeout: 60000
        }
      ],
      completion: "Beautiful work with the relaxation. You can return to this technique anytime you need it."
    }
  }), []);
  ...
  const generateAIResponse = useCallback((userInput, context = {}) => {
    ...
    const crisisKeywords = ['harm', 'suicide', 'kill', 'end it', 'die', 'hurt myself', 'not worth', 'give up'];
    ...
    if (currentExercise && context.exerciseStep !== undefined) {
      const exercise = therapyExercises[Object.keys(therapyExercises).find(key => 
        therapyExercises[key].id === currentExercise
      )];
    ...
    const responses = {
      ...
      depression: {
        keywords: ['sad', 'depressed', 'down', 'hopeless', 'empty', 'numb', 'worthless'],
        responses: [
      ...
      stress: {
        keywords: ['stressed', 'overwhelmed', 'pressure', 'too much', 'exhausted', 'burnt out'],
        responses: [
      ...
      anger: {
        keywords: ['angry', 'mad', 'furious', 'irritated', 'frustrated', 'rage'],
        responses: [
  ...
  const sendMessage = useCallback(async (messageText, messageType = 'text') => {
    ...
    setTimeout(() => {
      const context = currentExercise ? { 
        exerciseStep: messages.filter(m => m.type === 'exercise_step').length 
      } : {};
  ...
  }, [isAIResponding, currentExercise, messages, generateAIResponse, dispatch, sessionId]);
  ...
  const endSession = useCallback(async () => {
    ...
    const sessionSummary = {
      ...
      exercisesCompleted: messages.filter(m => m.type === 'exercise_complete').length,
